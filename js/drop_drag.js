document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.checkout__form-file').forEach(function (current_item, index) {

        const inputFile = current_item.querySelector('.checkout__form-file-input');

        // создаём массив файлов 
        let fileList = [];

        /////////// Кнопка «Прикрепить файл» /////////// 
        let textSelector = current_item.querySelector('.checkout__file-button-text');
        ...
        const dropZone = current_item.querySelector('.checkout__form-file-lable');
        const dropZoneText = current_item.querySelector('.checkout__file-button-text');
    ...
    //             el.querySelectorAll('.checkout__form-file-input').forEach((one_file, index) => {
    ...
    //                     document.querySelectorAll('.checkout__file-button-text').forEach(this_text => {
